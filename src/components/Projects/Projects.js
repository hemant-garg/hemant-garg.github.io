...
const PROJECTS = [
  {
    ...
    desp1:
      "A Simple, beautiful URL shortening website. Use our URL Shortener to create a shortened link making it easy to remember or share.",
    desp2:
      "I used the expressjs for making API endpoints and mongodb for storing the links data(shorturl, actualurl etc)",
    repo: "https://github.com/hemant-garg/url-shortener",
    website: "https://shorteasily.netlify.com/",
    tech: [
      "HTML5",
      "CSS3",
      "reactjs",
  ...
  },
  {
    ...
    desp2:
      "Want some beautiful colors for next project?? If yes, then you must check this website. Thanks ;)",
  ...
  },
  {
    ...
    desp2:
      "Its a pretty big website, So please check out the complete information on github repo. Thanks ;)",
    repo: "https://github.com/hemant-garg/Devhub-SocialNetwork",
    website: "https://devhub2.herokuapp.com/",
    tech: [
      "HTML5",
      "CSS3",
      "reactjs",
  ...
  },
  {
    ...
    desp2:
      "P.S. I know the profile photo is really bad, I'll change that soon. Thanks ;)",
  ...
  },
  {
    ...
    desp1:
      "A simple React Website which shows five videos based upon the users search",
